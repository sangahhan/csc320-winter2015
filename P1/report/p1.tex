...
\begin{figure*}[h!]
    ...
    \begin{subfigure}[b]{0.5\textwidth}
        \displayImage{00128u_part2out.png}{0.4}
        \caption{Runtime: 1.57219223579 minutes.}
    \end{subfigure}%
    ~
    \begin{subfigure}[b]{0.5\textwidth}
        \displayImage{01047u_part2out.png}{0.4}
        \caption{Runtime: 1.60740085045 minutes.}
    \end{subfigure}
    
    \begin{subfigure}[t]{0.5\textwidth}
        \displayImage{00458u_part2out.png}{0.4}
        \caption{Runtime: 1.58106016715 minutes. Note that upon close inspection, the green channel is slightly misaligned.}
    \end{subfigure}%
    ~
    \begin{subfigure}[t]{0.5\textwidth}
        \displayImage{00822u_part2out.png}{0.4}
